...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record4<Long, String, String, OffsetDateTime> {
    ...
    @Override
    @NotNull
    public LinkRecord values(@Nullable Long value1, @NotNull String value2, @Nullable String value3, @NotNull OffsetDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinkRecord(@Nullable Long id, @NotNull String url, @Nullable String description, @NotNull OffsetDateTime lastUpdated) {
        super(Link.LINK);
